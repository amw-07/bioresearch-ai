  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <BarChart data={data || defaultData}>
        ...
        <Tooltip cursor={{ fill: 'rgba(255,255,255,0.03)' }} contentStyle={{ background: 'rgba(11,18,36,0.95)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', color: '#e4e4e7' }} />
