  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={data || defaultData}>
        ...
        <Tooltip contentStyle={{ background: 'rgba(11,18,36,0.95)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', color: '#e4e4e7' }} />
        <Legend wrapperStyle={{ color: '#a1a1aa', fontSize: '12px' }} />
        <Line type="monotone" dataKey="created" stroke="#00d68f" strokeWidth={2.5} dot={{ r: 0 }} activeDot={{ r: 5, fill: '#00d68f' }} name="Researchers Indexed" />
        <Line type="monotone" dataKey="indexed" stroke="#a78bfa" strokeWidth={2.5} dot={{ r: 0 }} activeDot={{ r: 5, fill: '#a78bfa' }} name="Researchers" />
      </LineChart>
    </ResponsiveContainer>
  )
}
